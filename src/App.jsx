...
const SERVICES = [
  ...
  },
  {
    ...
    subcats: [
      ...
      {
        id: "laser_1z", label: "Forfait 8 séances · 1 zone", badge: "–30 %", hint: "11 zones au choix",
        note: "🎯 Le protocole complet en 8 séances, sur une seule zone. Prix affichés remise déduite.",
        prestations: [
          { id:"lz1", groupe:"Zones populaires", nom:"Aisselles",          duree:15, prix:280,  prixNormal:400,  remise:30, sousTitre:"soit 35 € la séance",     acompte:0 },
          { id:"lz2", groupe:"Zones populaires", nom:"Maillot simple",     duree:25, prix:392,  prixNormal:560,  remise:30, sousTitre:"soit 49 € la séance",     acompte:0 },
          { id:"lz3", groupe:"Zones populaires", nom:"Maillot échancré",   duree:30, prix:532,  prixNormal:760,  remise:30, sousTitre:"soit 66,50 € la séance",  acompte:0 },
          { id:"lz4", groupe:"Zones populaires", nom:"Maillot intégral",   duree:35, prix:672,  prixNormal:960,  remise:30, sousTitre:"soit 84 € la séance",     acompte:0 },
          { id:"lz5", groupe:"Jambes",           nom:"Demi-jambes",        duree:20, prix:728,  prixNormal:1040, remise:30, sousTitre:"soit 91 € la séance",     acompte:0 },
          { id:"lz6", groupe:"Jambes",           nom:"Cuisses",            duree:20, prix:812,  prixNormal:1160, remise:30, sousTitre:"soit 101,50 € la séance", acompte:0 },
          { id:"lz7", groupe:"Jambes",           nom:"Jambes entières",    duree:30, prix:1176, prixNormal:1680, remise:30, sousTitre:"soit 147 € la séance",    acompte:0 },
          { id:"lz8", groupe:"Bras",             nom:"Avant-bras",         duree:15, prix:504,  prixNormal:720,  remise:30, sousTitre:"soit 63 € la séance",     acompte:0 },
          { id:"lz9", groupe:"Bras",             nom:"Bras entiers",       duree:25, prix:672,  prixNormal:960,  remise:30, sousTitre:"soit 84 € la séance",     acompte:0 },
          { id:"lz10", groupe:"Homme",           nom:"Dos",                duree:30, prix:672,  prixNormal:960,  remise:30, sousTitre:"soit 84 € la séance",     acompte:0 },
          { id:"lz11", groupe:"Homme",           nom:"Torse",              duree:25, prix:616,  prixNormal:880,  remise:30, sousTitre:"soit 77 € la séance",     acompte:0 },
        ],
      },
      {
        id: "laser_2z", label: "Forfait 8 séances · 2 zones", badge: "–50 %", hint: "10 combinaisons",
        ...
        prestations: [
          { id:"l2a", groupe:"Aisselles + maillot", nom:"Aisselles + Maillot simple",           duree:55, prix:480,  prixNormal:960,  remise:50, sousTitre:"soit 60 € la séance",    acompte:0 },
          { id:"l2b", groupe:"Aisselles + maillot", nom:"Aisselles + Maillot échancré",         duree:60, prix:580,  prixNormal:1160, remise:50, sousTitre:"soit 72,50 € la séance", acompte:0 },
          { id:"l2c", groupe:"Aisselles + maillot", nom:"Aisselles + Maillot intégral",         duree:65, prix:680,  prixNormal:1360, remise:50, sousTitre:"soit 85 € la séance",    acompte:0 },
          { id:"l2d", groupe:"Aisselles + jambes",  nom:"Aisselles + Demi-jambes",              duree:50, prix:720,  prixNormal:1440, remise:50, sousTitre:"soit 90 € la séance",    acompte:0 },
          { id:"l2e", groupe:"Aisselles + jambes",  nom:"Aisselles + Jambes entières",          duree:60, prix:1040, prixNormal:2080, remise:50, sousTitre:"soit 130 € la séance",   acompte:0 },
          { id:"l2f", groupe:"Maillot + jambes",    nom:"Maillot échancré + Demi-jambes",       duree:65, prix:900,  prixNormal:1800, remise:50, sousTitre:"soit 112,50 € la séance", acompte:0 },
          { id:"l2g", groupe:"Maillot + jambes",    nom:"Maillot intégral + Demi-jambes",       duree:70, prix:1000, prixNormal:2000, remise:50, sousTitre:"soit 125 € la séance",   acompte:0 },
          { id:"l2h", groupe:"Maillot + jambes",    nom:"Maillot intégral + Jambes entières",   duree:80, prix:1320, prixNormal:2640, remise:50, sousTitre:"soit 165 € la séance",   acompte:0 },
          { id:"l2i", groupe:"Haut du corps",       nom:"Aisselles + Bras entiers",             duree:55, prix:680,  prixNormal:1360, remise:50, sousTitre:"soit 85 € la séance",    acompte:0 },
          { id:"l2j", groupe:"Homme",               nom:"Dos + Torse",                          duree:70, prix:920,  prixNormal:1840, remise:50, sousTitre:"soit 115 € la séance",   acompte:0 },
        ],
      },
      {
        id: "laser_3z", label: "Forfait 8 séances · 3 zones", badge: "–50 %", hint: "8 combinaisons",
        ...
        prestations: [
          { id:"l3a", groupe:"Les plus demandés", nom:"Aisselles + Maillot intégral + Demi-jambes",      duree:95,  prix:1200, prixNormal:2400, remise:50, sousTitre:"soit 150 € la séance",   acompte:0 },
          { id:"l3b", groupe:"Les plus demandés", nom:"Aisselles + Maillot intégral + Jambes entières",  duree:105, prix:1520, prixNormal:3040, remise:50, sousTitre:"soit 190 € la séance",   acompte:0 },
          { id:"l3c", groupe:"Les plus demandés", nom:"Aisselles + Maillot simple + Demi-jambes",        duree:85,  prix:1000, prixNormal:2000, remise:50, sousTitre:"soit 125 € la séance",   acompte:0 },
          { id:"l3d", groupe:"Les plus demandés", nom:"Aisselles + Maillot échancré + Demi-jambes",      duree:90,  prix:1100, prixNormal:2200, remise:50, sousTitre:"soit 137,50 € la séance", acompte:0 },
          { id:"l3e", groupe:"Autres combinaisons", nom:"Aisselles + Maillot intégral + Cuisses",        duree:95,  prix:1260, prixNormal:2520, remise:50, sousTitre:"soit 157,50 € la séance", acompte:0 },
          { id:"l3f", groupe:"Autres combinaisons", nom:"Aisselles + Maillot échancré + Jambes entières", duree:100, prix:1420, prixNormal:2840, remise:50, sousTitre:"soit 177,50 € la séance", acompte:0 },
          { id:"l3g", groupe:"Autres combinaisons", nom:"Aisselles + Bras entiers + Maillot intégral",   duree:100, prix:1160, prixNormal:2320, remise:50, sousTitre:"soit 145 € la séance",   acompte:0 },
          { id:"l3h", groupe:"Homme",               nom:"Dos + Torse + Aisselles",                       duree:95,  prix:1120, prixNormal:2240, remise:50, sousTitre:"soit 140 € la séance",   acompte:0 },
        ],
      },
      {
