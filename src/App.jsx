...
const SERVICES = [
  ...
  },
  {
    ...
    subcats: [
      ...
      {
        id: "laser_visage", label: "Visage",
        prestations: [
          { id:"lv1", nom:"Lèvre supérieure", duree:15, prix:30, acompte:10 },
          { id:"lv2", nom:"Menton", duree:15, prix:30, acompte:10 },
          { id:"lv3", nom:"Visage complet", duree:30, prix:60, acompte:20 },
        ],
      },
      {
        id: "laser_corps", label: "Corps",
        prestations: [
          { id:"lb1", nom:"Aisselles", duree:20, prix:45, acompte:15 },
          { id:"lb2", nom:"Maillot classique", duree:25, prix:55, acompte:15 },
          { id:"lb3", nom:"Maillot intégral", duree:35, prix:75, acompte:20 },
          { id:"lb4", nom:"Demi-jambes", duree:40, prix:65, acompte:20 },
          { id:"lb5", nom:"Jambes complètes", duree:60, prix:90, acompte:25 },
          { id:"lb6", nom:"Dos complet", duree:45, prix:80, acompte:25 },
          { id:"lb7", nom:"Forfait corps", duree:120, prix:180, acompte:50 },
        ],
      },
    ],
  },
                          ...
                          <div key={p.id} onClick={()=>!p.devis&&selectPresta(p,sub)} style={{padding:"14px 18px",borderTop:i>0?`1px solid ${C.borderLight}`:"none",display:"flex",justifyContent:"space-between",alignItems:"center",background:active?C.accentLight:"transparent",cursor:p.devis?"default":"pointer",transition:"background .15s"}}>
                            ...
                            <div style={{textAlign:"right",flexShrink:0}}>
                              {p.devis
                                ...
                                :<>
                                  <div style={{fontSize:15,fontWeight:700,color:active?C.accentDark:C.textMid}}>{p.prix} €</div>
